...
class Affordability(Reward):
    ...
    It contains the argumentation graph (AFDM) that stores the arguments and
    attacks between them, as well as the transform function, and performs
    the judgment over a given situation.
    """
    ...
    The framework we use (AFDM) supports multiple decisions, in this current
    ...
    when creating :py:class:`~.Argument`\\s and when performing the judgment!
    """
